...
test('the path target a jpg', async () => {
  expect(await fn(paths.fixtures.jpg)).toBe(true)
})

test('the path target a jxr', async () => {
  expect(await fn(paths.fixtures.jxr)).toBe(true)
})

test('the path target a png', async () => {
  expect(await fn(paths.fixtures.png)).toBe(true)
})
